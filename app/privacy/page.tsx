export const metadata = {
  title: "Politique de Confidentialité | Souk El Fellah (سوق الفلاح)",
  description: "Politique de confidentialité et protection des données personnelles de l'application Souk El Fellah conformément à la Loi 09-08 au Maroc.",
};
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          <section className="space-y-2">
            ...
            <p className="font-medium text-slate-900 dark:text-slate-100">
              Téléphone & WhatsApp : +212 7 22 95 78 26
            </p>
          </section>
        </div>
